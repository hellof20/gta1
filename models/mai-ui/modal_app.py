...
MODEL_ID = "Tongyi-MAI/MAI-UI-8B"
VOLUME_PATH = "/model-cache"

app = modal.App("mai-ui-inference")
...
model_volume = modal.Volume.from_name("mai-ui-model-cache", create_if_missing=True)
...
def create_app(inference):
    ...
    logger = logging.getLogger("mai-ui")
    ...
    SYSTEM_PROMPT = (
        ...
        "translate the user's instruction into a effective reasoning process, and then provide the final coordinate.\n"
        "## Output Format\n"
...
class Inference:
    ...
    def load_model(self):
        ...
        self.logger = logging.getLogger("mai-ui")
